...
class EnhancedTableHead4 extends React.Component {
    ...
    >
      <div className={classes.title}>
        {numSelected > 0 ? (
          ...
          <Typography variant="title">Erlanger Design Center Hours</Typography>
        )}
      </div>
...
class EnhancedTable extends React.Component {
  constructor(props, context) {
    ...
    componentDidMount() {
      var responseCopy;
        fetch(`http://localhost:3000/api/WfRequestIndices/?filter={%22limit%22:100,%20%22where%22:{%22designCenter%22:%22erlanger%22}}`) 
